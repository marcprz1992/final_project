...
fig4A = px.bar(
    ...
    orientation = "h",
    barmode = 'group',
    title=f'Average sentiment for <b>{option5A}</b>')
...
fig5A = px.bar(
    ...
    orientation = "v",
    barmode = 'group',
    title=f'Average sentiment for <b>{option5A}: {option5B}</b>')
...
fig6A = px.bar(
    ...
    orientation = "v",
    barmode = 'group',
    title=f'Average sentiment for <b>{option5C}</b>')
...
fig7A = px.bar(
    ...
    orientation = "v",
    barmode = 'group',
    title=f'Average sentiment for <b>{option5D}</b>')
st.plotly_chart(fig7A, use_container_width=True)


#st.markdown("![This is the image of the product you chose](https://digitalcontent.api.tesco.com/v2/media/ghs/d22e961f-d02e-4895-af3d-888479058d43/95ef88b6-d27c-48bd-b589-c670fbd7d746_788718938.jpeg?h=225&w=225)")
